...
// Placeholder data for Today's Patients (will be replaced with Supabase later)
...
const REFERRALS = ["Walk-in", "Dr. Rashid", "Website"] as const;
          ...
          <DialogContent className="sm:max-w-md">
            ...
            >
              <div className="grid gap-2">
                ...
                <Input id="name" placeholder="Enter name" className="h-10" />
              </div>
              <div className="grid gap-2">
